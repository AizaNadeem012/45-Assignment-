...
// let famous_person:string = "John Dalberg-Acton"

// console.log(`${famous_person} Once Said "Power corrupts; absolute power corrupts absolutely" `);


// // Qustion No 6;

// let whiteName: string = "             Aiza                "

// console.log(whiteName);

// let newName = whiteName.trim()
...
//  const myMessage :string = 'Wellcome To The Governor Sindh IT Initiative:';
...
// // /Changing Guest List: 
// let changing_guest_List :string[] = ["Aiza","Areeba","Wajahat","Ahmed"]
// for(let a=0; a<changing_guest_List.length; a++){
//     console.log(` Dear ${changing_guest_List[a]}: I am Inviting You For a Today Dinner`)
// }
...
// // / Question No 19:
// // Dinner Guests: 
// let Guest_List0 :Array<string> = [
//     "Zia Ullah Khan",
//     "Daniyal Nagori",
//     "Kamran Tesorri",
// ];
// for(let o=0; o<Guest_List0.length; o++) {
//   console.log(`We Had Finally invited ${Guest_List0 [o]}`)
// }
// // Question No 20:
...
// }
// let bouquet: Array<typeof bouquet1> = [];
// bouquet.push(bouquet1);
...
//   // Question No 42:
// // Great Magicians:
// const magicianNames2: string[] = ["Harry porter","David copperfield","Hermione Granger", "professor Albus Dumbledore", "Ron Weasley"];
...
// }
// const greatMagicianNames2: string[] = make_great(magicianNames);
